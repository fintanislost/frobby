...
public sealed class ScaffoldScenarioTool : ITool
{
    ...
    public string Description =>
        "Generate a starter .test.json skeleton. Optional 'template' (shop|menu|warp|npc_interaction|shop_purchase|tool_use|inventory_check) pre-fills steps and assertions.";
    ...
    public JsonElement InputSchema { get; } = JsonDocument.Parse("""
        {"type":"object",
         "properties":{
           ...
           "template":{"type":"string","enum":["shop","menu","warp","npc_interaction","shop_purchase","tool_use","inventory_check"],"description":"Optional step + assertion template"},
