...
**Out of scope (M4):**
- HTTP transport.
- Resource templates and resource subscriptions.
...
**2026-05-17 follow-up:** dynamic latest-report MCP resources landed for
process-local `run_scenario` summaries and file-backed CLI report artifacts.
